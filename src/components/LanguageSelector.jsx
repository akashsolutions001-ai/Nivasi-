    ...
    <>
      <div className="relative">
        <button 
          ...
          className="flex items-center gap-2 px-3 py-2 bg-white/20 backdrop-blur-sm rounded-lg text-white hover:bg-white/30 transition-all"
        >
          ...
          {availableLanguages.map((lang) => (
            <button
              ...
              className={`w-full px-4 py-2 text-left text-sm hover:bg-gray-50 transition-colors ${
                currentLanguage === lang ? 'bg-orange-50 text-orange-700 font-medium' : 'text-gray-700'
              }`}
            >
              {languageNames[lang]}
            </button>
